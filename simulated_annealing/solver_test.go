...
func TestSolve04(t *testing.T) {
	problem, err := utils.GetObjectFromFile[models.Problem]("../testdata/04_input.json")
	if err != nil {
		t.Fatal(err)
	}
	...
	expected, err := utils.GetObjectFromFile[models.Solution]("../testdata/04_output.json")
	if err != nil {
		t.Fatal(err)
	}
